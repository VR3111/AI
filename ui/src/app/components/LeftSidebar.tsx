...
export function LeftSidebar({
  ...
  const [documentsExpanded, setDocumentsExpanded] =
    useState(true);
  const [conversationsExpanded, setConversationsExpanded] =
    useState(true);
  ...
  const [showAllDocuments, setShowAllDocuments] =
    useState(false);
  const [showAllConversations, setShowAllConversations] =
    useState(false);
                      ...
                      >
                        <div className="flex items-start gap-2 mb-2">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div
                              className={`transition-all duration-200 ${showDocumentBadges ? "opacity-100 max-h-8" : "opacity-0 max-h-0 overflow-hidden"}`}
                            >
                              {doc.indexed ? (
                        ...
                        >
                          <svg
                            className={`w-3 h-3 transition-all duration-200 ${confirmBeforeDelete ? "opacity-100 w-3" : "opacity-0 w-0 overflow-hidden"}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                  ...
                  {documents.length > MAX_ITEMS_PREVIEW && (
                    <div className="px-2 mt-2">
                      ...
                      >
                        ...
                        <svg
                          className={`w-3 h-3 transition-transform duration-200 ${showAllDocuments ? "rotate-180" : ""}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      (conversation) => {
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-start gap-2 mb-2">
                              <div
                                className={`flex-shrink-0 mt-0.5 ${getResponseModeColor(firstTurn.response.mode)}`}
                              >
                                <svg
                                  className="w-3 h-3"
                                  fill="none"
                              ...
                              <div className="flex-1 min-w-0 text-xs leading-relaxed line-clamp-2 text-foreground/80">
                                {firstTurn.query}
                              </div>
                            </div>
                  ...
                  {filteredConversations.length >
                    ...
                    <div className="px-2 mt-2">
                      ...
                      >
                        ...
                        <svg
                          className={`w-3 h-3 transition-transform duration-200 ${showAllConversations ? "rotate-180" : ""}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
      ...
      <div className="relative border-t border-border/30 p-3">
        ...
        >
          ...
          <div className="w-9 h-9 bg-gradient-to-br from-primary to-primary/80 rounded-full flex items-center justify-center text-primary-foreground shadow-lg shadow-primary/20 transition-transform duration-200 group-hover:scale-105 relative overflow-hidden">
            ...
            <span className="text-sm relative">JD</span>
          </div>
          ...
          <svg
            className={`w-4 h-4 text-muted-foreground transition-transform duration-200 relative ${isProfileOpen ? "rotate-180" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
